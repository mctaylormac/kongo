    ...
    <section className="py-24 bg-gradient-kongo-subtle relative overflow-hidden">
      ...
      <div className="container-professional relative z-10">
        ...
        <motion.div
          ...
          className="relative"
        >
          <Card className="card-kongo card-kongo-contrast overflow-hidden">
            <CardContent className="p-12 text-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  <div className="flex items-center justify-center space-x-2">
                    <Zap className="w-6 h-6 text-kongo-lime" />
                    <Badge className="bg-kongo-lime text-kongo-black border-kongo-lime/60">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  {testimonialStats.map((stat, index) => (
                    ...
                    >
                      ...
                      <div className="text-caption text-white/90 font-medium">
                        {stat.sublabel}
                      </div>
                    </motion.div>
                  ))}
