  ...
  return (
    <footer className="bg-kongo-black text-on-black relative overflow-hidden">
      ...
      <div className="container-professional relative z-10">
            ...
            >
              {footerStats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-body-small text-white/90 font-medium">{stat.label}</div>
                </motion.div>
              ))}
            </motion.div>
          </div>
        ...
        {/* Main Footer Content */}
        <div className="py-16 bg-kongo-black-light/35 rounded-3xl border border-kongo-black-lighter/60 px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Description avec layout amélioré */}
              <div className="space-y-4 max-w-md">
                <p className="text-body text-on-black leading-relaxed">
                  La première plateforme digitale de réservation de transport en RDC.
                </p>
                <div className="inline-flex items-center bg-kongo-lime/10 border border-kongo-lime/20 rounded-lg px-3 py-1.5">
                  <span className="text-kongo-lime font-bold text-sm tracking-tight">
                    Sécurisé • Fiable • Accessible 24h/24
                  </span>
                </div>
              </div>

              {/* Contact Info avec contraste amélioré */}
              <div className="space-y-3 pt-2">
                <div className="flex items-center space-x-3 text-on-black">
                  <MapPin className="w-4 h-4 text-kongo-lime shrink-0" />
                  <span className="text-body-small font-medium">Avenue Lumumba, Gombe, Kinshasa</span>
                </div>
                
                <button
                  onClick={() => window.open('tel:+243123456789', '_self')}
                  className="flex items-center space-x-3 text-on-black hover:text-kongo-lime transition-colors group"
                >
                  <Phone className="w-4 h-4 text-kongo-lime shrink-0" />
                  <span className="text-body-small font-semibold group-hover:underline">+243 123 456 789</span>
                </button>
                ...
                <button
                  ...
                  className="flex items-center space-x-3 text-on-black hover:text-kongo-lime transition-colors group"
                >
                  <Mail className="w-4 h-4 text-kongo-lime shrink-0" />
                  <span className="text-body-small font-semibold group-hover:underline">contact@kongo-transport.cd</span>
                </button>
              </div>
              ...
              <div className="flex items-center space-x-2 text-kongo-lime pt-2">
                ...
                <span className="text-body-small font-semibold text-white">Meilleur Service Transport RDC 2024</span>
              </div>
            </div>
                ...
                <ul className="space-y-3">
                  {section.links.map((link, index) => (
                    <li key={index}>
                      <button
                        onClick={link.action}
                        className="text-body-small text-on-black hover:text-kongo-lime transition-colors text-left group flex items-center font-medium"
                      >
              ...
              {quickRoutes.map((route, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight className="w-4 h-4 text-white/90 group-hover:text-kongo-lime group-hover:translate-x-1 transition-all" />
                  </div>
        ...
        <div className="py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-4 text-caption text-white/90 font-medium">
            ...
            {/* Social Links */}
            <div className="flex items-center space-x-3">
              <span className="text-body-small text-white/90 mr-2 font-medium">Suivez-nous</span>
