...
import type { AuthCredentials, SocialProvider } from "./app/AppTypes";
...
export function LoginPage({
  ...
  const benefits = [
    { icon: Star, title: "Reservations prioritaires", description: "Acces exclusif aux sieges premium" },
    { icon: Zap, title: "Paiement rapide", description: "Mobile Money, cartes et paiement securise" },
    { icon: Users, title: "Programme fidelite", description: "Gagnez des points a chaque voyage" },
    { icon: MapPin, title: "200+ destinations", description: "Reseau etendu a travers la RDC" },
    { icon: Shield, title: "Voyage securise", description: "Flotte moderne et certifiee" },
  ...
  const validateForm = () => {
    ...
    if (!formData.password) {
      ...
      errors.password = "Minimum 6 caracteres";
    }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h2 className="text-display-2 text-kongo-black">
                  Voyagez en toute <span className="text-kongo-lime">serenite</span>
                </h2>
                <p className="text-body-large text-secondary max-w-md">
                  Rejoignez plus de 50,000 voyageurs qui font confiance a KonGO pour leurs
                  deplacements a travers la Republique Democratique du Congo.
                </p>
              </div>
            </div>
            ...
            <AnimatePresence mode="wait">
              {!showForgotPassword ? (
                  ...
                  <Card className="card-elevated">
                    <CardHeader className="text-center space-y-2">
                      ...
                      <p className="text-body text-secondary">
                        Accedez a votre compte KonGO pour gerer vos voyages
                      </p>
                    </CardHeader>
                ...
                <motion.div key="forgot" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  <Card className="card-elevated">
                    <CardHeader className="text-center space-y-2">
                      <CardTitle className="text-h3 text-kongo-black">Mot de passe oublie</CardTitle>
                      <p className="text-body text-secondary">
                        Entrez votre email pour recevoir un lien de recuperation
                      </p>
                    </CardHeader>
                      ...
                      {!forgotPasswordSent ? (
                        <form onSubmit={handleForgotPassword} className="space-y-4">
                          ...
                          <div className="flex space-x-3">
                            <Button type="button" variant="outline" onClick={() => setShowForgotPassword(false)} className="flex-1 h-12">
                              Retour
                            </Button>
                        ...
                        <div className="text-center space-y-4">
                          ...
                          <div className="space-y-2">
                            <h3 className="text-h4 text-kongo-black">Email envoye !</h3>
                            <p className="text-body text-secondary">
