          ...
          <DropdownMenuContent align="end" className="w-40">
            {languages.map((lang) => (
              <DropdownMenuItem
                ...
                className={`flex items-center space-x-3 cursor-pointer transition-colors ${lang.code === currentLanguage ? 'bg-surface-kongo-lime-light' : ''
                  }`}
              >
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            {userRole === 'guest' ? (
              ...
              <>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={onLogout} className="flex items-center px-4 py-3 cursor-pointer text-error hover:bg-error/10">
