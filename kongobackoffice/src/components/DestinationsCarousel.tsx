        ...
        >
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                className="btn-secondary btn-cta-contrast px-8 py-4"
                onClick={() => {
                  window.dispatchEvent(new CustomEvent("navigate-to-search"));
                }}
              >
              ...
              <Button
                className="btn-outline btn-cta-contrast px-8 py-4"
                onClick={() => {
                  window.location.href = "mailto:contact@kongo-transport.cd?subject=Demande de trajet personnalis%C3%A9&body=Bonjour%2C%0A%0AJe souhaite r%C3%A9server un trajet personnalis%C3%A9.%0A%0AMerci.";
                }}
              >
