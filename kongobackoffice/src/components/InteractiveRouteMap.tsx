          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <CardTitle className="text-h4 text-kongo-black flex items-center">
                <Route className="w-6 h-6 mr-3 text-kongo-lime shrink-0" />
                Carte du Trajet
              </CardTitle>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button
                ...
                className="btn-ghost text-body-small shrink-0"
              >
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-3 text-body-small">
                    <div className="flex items-start justify-between gap-2">
                      <span className="text-kongo-lime-dark flex-1">Distance totale</span>
                      <span className="text-kongo-black font-semibold text-right shrink-0">~1,200 km</span>
                    </div>
                    <div className="flex items-start justify-between gap-2">
                      <span className="text-kongo-lime-dark flex-1">Durée estimée</span>
                      <span className="text-kongo-black font-semibold text-right shrink-0">16h</span>
                    </div>
                    <div className="flex items-start justify-between gap-2">
                      <span className="text-kongo-lime-dark flex-1">Arrêts prévus</span>
                      <span className="text-kongo-black font-semibold text-right shrink-0">{mapPoints.filter(p => p.type === 'stop').length}</span>
                    </div>
                    <div className="flex items-start justify-between gap-2">
                      <span className="text-kongo-lime-dark flex-1">Hôtels à proximité</span>
                      <span className="text-kongo-black font-semibold text-right shrink-0">{mapPoints.filter(p => p.type === 'hotel').length}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
