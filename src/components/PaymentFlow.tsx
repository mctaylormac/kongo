...
export function PaymentFlow({ 
  ...
  const paymentMethods: PaymentMethod[] = [
    ...
    },
    {
      ...
      supported: true,
      popular: true,
      bonus: "Cashback 1% sur votre première réservation"
    },
    {
      id: "mpesa",
      name: "M-Pesa Vodacom",
      ...
      processingTime: "Instantané",
      supported: true,
      bonus: "Points de fidélité doublés"
    },
    {
      id: "visa_card",
      name: "Carte Visa",
      type: "card",
      logoType: "visa",
      description: "Cartes de crédit/débit Visa acceptées partout",
      fees: 0.035, // 3.5%
    ...
    },
    {
      ...
      type: "card", 
      logoType: "mastercard",
      description: "Cartes de crédit/débit Mastercard",
      fees: 0.035, // 3.5%
      processingTime: "2-5 minutes", 
      supported: isOnline
    },
  ...
  const applyPromoCode = () => {
    if (promoCode.toLowerCase() === "kongo10" || promoCode.toLowerCase() === "welcome") {
      ...
      toast.success("🎉 Code promo appliqué !", {
        description: "10% de réduction sur votre réservation"
      });
    } else {
  ...
  const handlePaymentSubmit = async () => {
    ...
    // Auto-fill missing contact information for demo
    const autoFilledData = {
      firstName: paymentData.firstName || "Jean",
      lastName: paymentData.lastName || "Dupont",
      email: paymentData.email || "jean.dupont@email.com",
      phone: paymentData.phone || "+243 123 456 789",
      ...paymentData
    };
    ...
    try {
      ...
      toast.success("🎉 Paiement réussi !", { 
        id: 'payment',
        description: "Votre réservation a été confirmée. Billet envoyé par email.",
        action: {
      ...
      toast.error("Erreur de paiement", {
        id: 'payment',
        description: "Veuillez réessayer ou changer de méthode"
      });
    } finally {
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="text-body-xs text-tertiary mt-2 flex items-center space-x-2">
                  ...
                  <span>Code de confirmation envoyé automatiquement</span>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="bg-surface-secondary border border-border-secondary p-6 rounded-lg">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-body-small">
                      ...
                      <div className="flex justify-between">
                        <span className="text-secondary font-medium">Référence :</span> 
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="text-body-small text-orange-800">
                  ...
                  <div className="leading-relaxed">
                    Votre réservation sera confirmée après validation du virement ({method.processingTime}). 
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      ...
                      <p className="text-body-large text-white/90 mb-2">
                        {trip?.from} → {trip?.to} • {seats.length} siège{seats.length > 1 ? 's' : ''} • {trip?.date}
                      </p>
                ...
                <Card className="card-elevated">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="text-body-xs text-tertiary mt-2 flex items-center space-x-2">
                        <CheckCircle2 className="w-4 h-4 text-success" />
                        <span>Votre billet électronique sera envoyé à cette adresse</span>
                      </div>
                    </div>
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center space-x-4 p-4 bg-surface-secondary border border-border-secondary rounded-lg">
                    <div className="w-12 h-12 bg-kongo-lime rounded-xl flex items-center justify-center">
                      <span className="text-kongo-black font-bold text-lg">🚌</span>
                    </div>
                    <div className="flex-1">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-body-small text-secondary">Sièges ({seats.length})</span>
                ...
                <CardContent>
                  {!promoApplied ? (
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-success/10 border border-success/30 rounded-lg">
                      ...
                      <div className="flex-1">
                        <div className="text-body-small font-semibold text-success">Code appliqué avec succès</div>
                        <div className="text-body-xs text-success/80">{promoCode} - 10% de réduction</div>
                      </div>
                    </div>
                  )}
                </CardContent>
