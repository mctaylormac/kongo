              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('profile', 'city', value)}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('profile', 'preferredLanguage', value)}
                  >
                    <SelectTrigger className="h-12">
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updatePreference('profile', 'dateOfBirth', e.target.value)}
                    className="h-12"
                  />
                </div>
              </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('travel', 'preferredSeatType', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('travel', 'comfortLevel', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('travel', 'preferredTimeOfDay', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updatePreference('travel', 'maxTravelDuration', value)}
                    max={24}
                    min={4}
                    step={2}
                    className="w-full"
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  onValueChange={(value) => updatePreference('travel', 'budgetRange', value)}
                  max={500000}
                  min={25000}
                  step={25000}
                  className="w-full"
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('ui', 'theme', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('ui', 'colorScheme', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updatePreference('ui', 'fontSize', value)}
                    max={1.5}
                    min={0.8}
                    step={0.1}
                    className="w-full"
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreference('ui', 'animations', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreference('ui', 'soundEffects', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreference('ui', 'autoSave', checked)}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => updatePreference('payment', 'preferredMethod', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreference('payment', 'savedPaymentMethods', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreference('payment', 'autoFillPayment', checked)}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreference('payment', 'twoFactorAuth', checked)}
                  />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updatePreference('payment', 'sessionTimeout', value)}
                    max={120}
                    min={15}
                    step={15}
                    className="w-full"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'enablePersonalization', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'shareDataForML', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'smartSuggestions', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'priceOptimization', checked)}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'routeOptimization', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'weatherIntegration', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updatePreference('recommendations', 'eventBasedSuggestions', checked)}
                    />
                  </div>
                </div>
              </div>
