                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <span className={`text-xl font-semibold ${currentTier.color.replace('text-', 'text-')}`}>
                            {currentTier.name}
                          </span>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-300">points KonGO</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-300">Voyages cette année</div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-300">Distance parcourue</div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-300">Réduction actuelle</div>
                      </motion.div>
                    </div>
                  </div>
                  ...
                  <div>
                      ...
                      {currentTier.benefits.map((benefit, index) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-gray-300 text-sm">Actif sur votre compte</div>
                          </div>
                    ...
                    <motion.div
                      ...
                      className="mt-8 p-6 bg-gradient-to-r from-kongo-lime/10 to-yellow-400/10 border border-kongo-lime/30 rounded-lg backdrop-blur-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {loyaltyTiers.map((tier, index) => {
                ...
                return (
                  ...
                  >
                    <Card className={`bg-white/5 border-2 text-white hover:bg-white/10 transition-all duration-300 relative overflow-hidden ${
                      isCurrentTier ? 'border-kongo-lime bg-kongo-lime/5' : 'border-white/20'
                    }`}>
                      {isCurrentTier && (
                        <motion.div
                          initial={{ width: 0 }}
                      ...
                      <CardContent className="p-6 text-center relative">
                        ...
                        <p className="text-gray-300 text-sm mb-6">{tier.trips}</p>
