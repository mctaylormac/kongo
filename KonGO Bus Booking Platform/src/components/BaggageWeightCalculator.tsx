      ...
      <div className="bg-transparent space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              variant="outline" 
              className="h-20 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center gap-1 hover:border-kongo-lime hover:bg-kongo-lime/5"
              onClick={() => addBaggage('cabine')}
            >
              <Package className="w-5 h-5 text-kongo-lime" />
              <span className="text-caption font-bold">Cabine</span>
            </Button>
            <Button 
              variant="outline" 
              className="h-20 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center gap-1 hover:border-kongo-lime hover:bg-kongo-lime/5"
            ...
            >
              <Luggage className="w-5 h-5 text-kongo-lime" />
              <span className="text-caption font-bold">Soute</span>
            </Button>
          </div>
