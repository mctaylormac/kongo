  ...
  const quickActions = [
    {
      ...
      action: () => {
        ...
        toast.success("🌙 Mode sombre", {
          description: document.body.classList.contains("dark")
            ? "Activé"
            : "Désactivé",
        });
      },
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-32 left-4 md:top-24 md:bottom-auto z-50"
      >
        <motion.button
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-border-primary bg-gradient-to-r from-surface-primary to-surface-secondary">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-h3 text-kongo-black font-bold">
                      Accessibilité KonGO
                    </h2>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-surface-kongo-lime-light rounded-lg border border-kongo-lime/20">
                      ...
                      <p className="text-caption text-kongo-lime-darker">
                        KonGO s'engage à être accessible à tous les
                        utilisateurs, conformément aux standards WCAG 2.1 AA.
                      </p>
                    </div>
                  </div>
                </div>
