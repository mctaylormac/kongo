                ...
                <div key={b.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button 
                      ...
                      className="w-10 h-10 bg-kongo-lime/10 text-kongo-lime rounded-lg flex items-center justify-center hover:bg-kongo-lime hover:text-kongo-black transition-all"
