    ...
    return (
        <div className="p-6 space-y-8">
            <div className="flex items-center justify-between">
                ...
                <button className="btn-outline border-kongo-black flex items-center px-6 py-2 rounded-lg hover:bg-kongo-black hover:text-white transition-all">
            ...
            <div className="bg-surface-elevated p-4 rounded-xl border border-border-primary flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-body-small font-bold ${statusFilter === 'all' ? 'bg-kongo-black text-white' : 'hover:bg-gray-100'}`}
                    >
                        Tous
                    </button>
                    <button
                        onClick={() => setStatusFilter('completed')}
                        className={`px-4 py-2 rounded-lg text-body-small font-bold ${statusFilter === 'completed' ? 'bg-kongo-black text-white' : 'hover:bg-gray-100'}`}
                    >
                        Payés
                    </button>
                    <button
                        onClick={() => setStatusFilter('pending')}
                        className={`px-4 py-2 rounded-lg text-body-small font-bold ${statusFilter === 'pending' ? 'bg-kongo-black text-white' : 'hover:bg-gray-100'}`}
                    >
                        En attente
                    </button>
                </div>
                                ...
                                <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button 
                                          ...
                                          className="p-2 hover:bg-surface-secondary rounded-lg text-secondary transition-colors"
                                        >
